...
//                String date1 = new Date().toString().valueOf(tvNgaybd);
//
//                String date2 = new Date().toString().valueOf(tvNgaykt);
//
//                if(date1.equals(date2)){
//                    Toast.makeText(TaoHopDong.this,"Ngày Kết Thúc Phải Lớn Hơn Ngày Bắt Đầu",Toast.LENGTH_LONG).show();
//                    return;
//                }
