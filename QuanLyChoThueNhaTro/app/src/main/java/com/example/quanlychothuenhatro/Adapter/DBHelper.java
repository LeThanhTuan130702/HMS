...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public float getTongTienTheoThang(int thang,int nam) {
    ...
    public float getTongTienTheoQuy(String sql) {
        float TongTien= Float.parseFloat("0");
    ...
    public float getTongTienTheoNam(int nam) {
        float TongTien = Float.parseFloat("0");
